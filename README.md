...
NeCTAR Research Cloud.  This repository is the master location for documentation,
content added here (by means of the workflows below) will be visible not only
...
Any content funded by NeCTAR is available for assimilation and standardisation
...
can't push directly to github yourself because only Gerrit is authorised to
