...
exactly the same as as when writing in other mark-up languages such as HTML.
...
or even better, markdown parsing in near real-time with
`watch mdl README.md`
...
You need two +1 votes (or one +2) for your change to be accepted, merged and to
 ...
 amendments before they are finally accepted.
...
(or "merged").  It's important that you don't submit your changes as a separate
 omit, but that you amend your existing commit.
...
See the NeCTAR wiki for more documentation on [making changes after committing](https://wiki.rc.nectar.org.au/wiki/ChangeWorkflow#Making_more_changes_after_committing.).
