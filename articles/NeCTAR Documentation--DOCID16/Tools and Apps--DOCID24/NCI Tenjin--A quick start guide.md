...
### Example
  ...
  1.  Next you need to mount NFS export on your cloud instance. Typical mount options for gdata are:  ```hard,fg,defaults,nosuid,exec,rw,noatime,intr,rsize=32768,wsize=32768```
