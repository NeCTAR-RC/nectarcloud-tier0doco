...
2. Extract **rclone.exe** from the zip file and save it. (e.g., as C:\users\fred\rclone.exe)
3. All configuration and examples in the Linux section are as below, run from within a cmd.exe shell.
