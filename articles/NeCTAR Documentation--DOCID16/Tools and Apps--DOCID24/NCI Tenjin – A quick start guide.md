...
11. Attach the volume it to the virtual machine. It will most probably get attached as /dev/vdc but it is always a good idea to check.
...
'''
2.  Next you need to mount NFS export on your cloud instance. Typical mount options for gdata are:
