...
You need to create a public/private key pair before you can use SSH to login to the
newly created instance. The public key will be inserted into the instance and the 
private key is used on your desktop/laptop.
